...
DEBUG = false; % Set DEBUG to true when debugging.梯度检验以后要把检验关闭（DEBUG从true变为false）再进行后面的内容
if DEBUG
    inputSize = 8;
...
% Randomly initialise theta，theta转为列向量
